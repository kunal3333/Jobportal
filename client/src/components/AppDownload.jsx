...
const AppDownload = () => {
  return (
    <div className='container px-4 2xl:px-20 mx-auto my-20'>
        <div className='relative bg-gradient-to-r from-violet-50 to-purple-50 p-12 sm:p-24 '>
            <div>
                <h1 className='text-2xl sm:text-4xl font-bold mb-8 max-w-md'>Download Mobile App fro better Experience</h1>
